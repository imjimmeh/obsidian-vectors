...
Your task is to extract up to {queryCount} key words/phrases, or synonyms, from the user's query.

By generating multiple perspectives on the user question, your goal is to help the user overcome some of the limitations of distance-based similarity search.
Given their query, try to break down their query into smaller components, so that you can find the right information from their notes for their query.
...
User Stories
Tasks
Cool Development Project Development
Project
